...
<main class="container d-flex justify-content-center align-items-center my-3">
    <div class="card shadow-sm pt-2 ps-4 pe-4 pb-4" style="max-width: 900px; width: 100%;">
        ...
        <form id="multiStepForm" action="/controllers/createAddressCreateProperty.php" method="POST">
            ...
            <div class="step d-none" id="step-2">
                <h4>¿Qué tipo de casa es?</h4>
                <div class="mb-3">
                    <label for="property_type" class="form-label">Tipo de vivienda</label>
                    <br>
                    <input type="radio" id="property_type_1" name="property_type" value="Habitación" checked />
                    <label for="true" class="me-3">Habitación</label>
                    <input type="radio" id="property_type_2" name="property_type" value="Estudio" />
                    <label for="false" class="me-3">Estudio</label>
                    <input type="radio" id="property_type_3" name="property_type" value="Piso" />
                    <label for="false" class="me-3">Piso</label>
                    <input type="radio" id="property_type_4" name="property_type" value="Casa" />
                ...
                <div class="mb-3">
                    ...
                    <br>
                    <input type="radio" id="status_1" name="status" value="Habitación" checked />
                    <label for="Obra nueva" class="me-3">Obra nueva</label>
                    <input type="radio" id="status_2" name="status" value="Estudio" />
                    <label for="Reformado" class="me-3">Reformado</label>
                    <input type="radio" id="status_3" name="status" value="Piso" />
                    <label for="A reformar" class="me-3">A reformar</label>
                    <input type="radio" id="status_4" name="status" value="Casa" />
                ...
                <div class="mb-3">
                    ...
                    <br>
                    <input type="radio" id="immediate_availability_1" name="immediate_availability" value="true" checked />
                    <label for="true" class="me-3">Sí</label>
                    <input type="radio" id="immediate_availability_2" name="immediate_availability" value="false" />
            ...
            <div class="step d-none" id="step-3">
                ...
                <div class="mb-3">
                    <!-- Campos de la propiedad específicos del modelo o del dto -->
